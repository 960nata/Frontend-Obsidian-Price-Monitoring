      ...
      <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        {!isAuthenticated() && (
          <nav className="hidden md:flex items-center gap-10 text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400">
            <a className="hover:text-neon-mint transition-colors" href="#intelligence">
              {language === 'id' ? 'Kecerdasan' : 'Intelligence'}
            </a>
            <a className="hover:text-neon-mint transition-colors" href="#networks">
              {language === 'id' ? 'Jaringan' : 'Networks'}
            </a>
            <a className="hover:text-neon-mint transition-colors" href="#api">
              API
            </a>
            <a className="hover:text-neon-mint transition-colors" href="#enterprise">
              {language === 'id' ? 'Perusahaan' : 'Enterprise'}
            </a>
          </nav>
        )}
